...
def parse_csv(input_file):
    with open(input_file, 'r+') as f_in:
        ...
        for row in reader:
            ...
            output.append([article_doi, ','.join(stm_cited_dois), len(stm_cited_dois), ','.join(datacite_cited_dois), len(datacite_cited_dois), str(stm_same_as_datacite), len(stm_cited_dois)-len(datacite_cited_dois)])
